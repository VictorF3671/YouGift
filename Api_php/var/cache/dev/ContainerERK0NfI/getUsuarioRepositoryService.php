...
class getUsuarioRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'core'.\DIRECTORY_SEPARATOR.'Domain'.\DIRECTORY_SEPARATOR.'Usuario'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'IUsuarioRepository.php';
        ...
        if (isset($container->privates['App\\Repository\\UsuarioRepository'])) {
            return $container->privates['App\\Repository\\UsuarioRepository'];
        }

        return $container->privates['App\\Repository\\UsuarioRepository'] = new \App\Repository\UsuarioRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)), $a);
    }
}
