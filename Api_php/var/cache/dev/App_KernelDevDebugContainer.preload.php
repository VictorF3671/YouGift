...
(require __DIR__.'/App_KernelDevDebugContainer.php')->set(\ContainerHG4X8As\App_KernelDevDebugContainer::class, null);
require __DIR__.'/ContainerHG4X8As/UriSignerGhostB68a0a1.php';
require __DIR__.'/ContainerHG4X8As/EntityManagerGhost614a58f.php';
require __DIR__.'/ContainerHG4X8As/RequestPayloadValueResolverGhost01ca9cc.php';
require __DIR__.'/ContainerHG4X8As/getValidator_WhenService.php';
require __DIR__.'/ContainerHG4X8As/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/ContainerHG4X8As/getValidator_NoSuspiciousCharactersService.php';
require __DIR__.'/ContainerHG4X8As/getValidator_ExpressionLanguageService.php';
require __DIR__.'/ContainerHG4X8As/getValidator_ExpressionService.php';
require __DIR__.'/ContainerHG4X8As/getValidator_EmailService.php';
require __DIR__.'/ContainerHG4X8As/getUriSignerService.php';
require __DIR__.'/ContainerHG4X8As/getTwig_Runtime_SerializerService.php';
require __DIR__.'/ContainerHG4X8As/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/ContainerHG4X8As/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/ContainerHG4X8As/getTwigService.php';
require __DIR__.'/ContainerHG4X8As/getSession_Handler_NativeService.php';
require __DIR__.'/ContainerHG4X8As/getSession_FactoryService.php';
require __DIR__.'/ContainerHG4X8As/getServicesResetterService.php';
require __DIR__.'/ContainerHG4X8As/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/ContainerHG4X8As/getSecurity_RouteLoader_LogoutService.php';
require __DIR__.'/ContainerHG4X8As/getSecurity_PasswordHasherFactoryService.php';
require __DIR__.'/ContainerHG4X8As/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/ContainerHG4X8As/getSecurity_Listener_UserProviderService.php';
require __DIR__.'/ContainerHG4X8As/getSecurity_Listener_UserChecker_LoginService.php';
require __DIR__.'/ContainerHG4X8As/getSecurity_Listener_UserChecker_ApiService.php';
require __DIR__.'/ContainerHG4X8As/getSecurity_Listener_PasswordMigratingService.php';
require __DIR__.'/ContainerHG4X8As/getSecurity_Listener_CsrfProtectionService.php';
require __DIR__.'/ContainerHG4X8As/getSecurity_Listener_CheckAuthenticatorCredentialsService.php';
require __DIR__.'/ContainerHG4X8As/getSecurity_Listener_Api_UserProviderService.php';
require __DIR__.'/ContainerHG4X8As/getSecurity_HttpUtilsService.php';
require __DIR__.'/ContainerHG4X8As/getSecurity_Firewall_Map_Context_LoginService.php';
require __DIR__.'/ContainerHG4X8As/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/ContainerHG4X8As/getSecurity_Firewall_Map_Context_ApiService.php';
require __DIR__.'/ContainerHG4X8As/getSecurity_ChannelListenerService.php';
require __DIR__.'/ContainerHG4X8As/getSecurity_Authenticator_Jwt_ApiService.php';
require __DIR__.'/ContainerHG4X8As/getSecurity_AccessMapService.php';
require __DIR__.'/ContainerHG4X8As/getSecurity_AccessListenerService.php';
require __DIR__.'/ContainerHG4X8As/getSecrets_VaultService.php';
require __DIR__.'/ContainerHG4X8As/getSecrets_EnvVarLoaderService.php';
require __DIR__.'/ContainerHG4X8As/getRouting_LoaderService.php';
require __DIR__.'/ContainerHG4X8As/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/ContainerHG4X8As/getNelmioApiDoc_Routes_DefaultService.php';
require __DIR__.'/ContainerHG4X8As/getNelmioApiDoc_RouteDescribers_RouteArgumentService.php';
require __DIR__.'/ContainerHG4X8As/getNelmioApiDoc_RenderDocsService.php';
require __DIR__.'/ContainerHG4X8As/getNelmioApiDoc_ModelDescribers_ObjectService.php';
require __DIR__.'/ContainerHG4X8As/getNelmioApiDoc_Generator_DefaultService.php';
require __DIR__.'/ContainerHG4X8As/getNelmioApiDoc_Describers_Security_DefaultService.php';
require __DIR__.'/ContainerHG4X8As/getNelmioApiDoc_Describers_Route_DefaultService.php';
require __DIR__.'/ContainerHG4X8As/getNelmioApiDoc_Describers_OpenapiPhp_DefaultService.php';
require __DIR__.'/ContainerHG4X8As/getNelmioApiDoc_Describers_ConfigService.php';
require __DIR__.'/ContainerHG4X8As/getNelmioApiDoc_Describers_ApiPlatformService.php';
require __DIR__.'/ContainerHG4X8As/getNelmioApiDoc_Controller_SwaggerYamlService.php';
require __DIR__.'/ContainerHG4X8As/getNelmioApiDoc_Controller_SwaggerUiService.php';
require __DIR__.'/ContainerHG4X8As/getNelmioApiDoc_Controller_SwaggerJsonService.php';
require __DIR__.'/ContainerHG4X8As/getNelmioApiDoc_Controller_StoplightService.php';
require __DIR__.'/ContainerHG4X8As/getNelmioApiDoc_Controller_RedoclyService.php';
require __DIR__.'/ContainerHG4X8As/getLexikJwtAuthentication_KeyLoaderService.php';
require __DIR__.'/ContainerHG4X8As/getLexikJwtAuthentication_JwtManagerService.php';
require __DIR__.'/ContainerHG4X8As/getLexikJwtAuthentication_EncoderService.php';
require __DIR__.'/ContainerHG4X8As/getLexikJwtAuthentication_ApiPlatform_Openapi_FactoryService.php';
require __DIR__.'/ContainerHG4X8As/getFragment_Renderer_InlineService.php';
require __DIR__.'/ContainerHG4X8As/getErrorControllerService.php';
require __DIR__.'/ContainerHG4X8As/getDoctrine_UuidGeneratorService.php';
require __DIR__.'/ContainerHG4X8As/getDoctrine_UlidGeneratorService.php';
require __DIR__.'/ContainerHG4X8As/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/ContainerHG4X8As/getDoctrine_Orm_Listeners_PdoSessionHandlerSchemaListenerService.php';
require __DIR__.'/ContainerHG4X8As/getDoctrine_Orm_Listeners_LockStoreSchemaListenerService.php';
require __DIR__.'/ContainerHG4X8As/getDoctrine_Orm_Listeners_DoctrineTokenProviderSchemaListenerService.php';
require __DIR__.'/ContainerHG4X8As/getDoctrine_Orm_Listeners_DoctrineDbalCacheAdapterSchemaListenerService.php';
require __DIR__.'/ContainerHG4X8As/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/ContainerHG4X8As/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/ContainerHG4X8As/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/ContainerHG4X8As/getDebug_Security_Firewall_Authenticator_LoginService.php';
require __DIR__.'/ContainerHG4X8As/getDebug_Security_Firewall_Authenticator_ApiService.php';
require __DIR__.'/ContainerHG4X8As/getDebug_Security_EventDispatcher_LoginService.php';
require __DIR__.'/ContainerHG4X8As/getDebug_Security_EventDispatcher_ApiService.php';
require __DIR__.'/ContainerHG4X8As/getDebug_Security_Authenticator_Jwt_ApiService.php';
require __DIR__.'/ContainerHG4X8As/getDebug_Security_Authenticator_JsonLogin_LoginService.php';
require __DIR__.'/ContainerHG4X8As/getDebug_ErrorHandlerConfiguratorService.php';
require __DIR__.'/ContainerHG4X8As/getController_TemplateAttributeListenerService.php';
require __DIR__.'/ContainerHG4X8As/getContainer_GetenvService.php';
require __DIR__.'/ContainerHG4X8As/getContainer_GetRoutingConditionServiceService.php';
require __DIR__.'/ContainerHG4X8As/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/ContainerHG4X8As/getContainer_EnvVarProcessorService.php';
require __DIR__.'/ContainerHG4X8As/getCache_ValidatorExpressionLanguageService.php';
require __DIR__.'/ContainerHG4X8As/getCache_SystemClearerService.php';
require __DIR__.'/ContainerHG4X8As/getCache_SystemService.php';
require __DIR__.'/ContainerHG4X8As/getCache_GlobalClearerService.php';
require __DIR__.'/ContainerHG4X8As/getCache_AppClearerService.php';
require __DIR__.'/ContainerHG4X8As/getCache_AppService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_Validator_State_ErrorProviderService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_Symfony_MainControllerService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_SwaggerUi_ProcessorService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_SwaggerUi_ContextService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_SwaggerUi_ActionService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_StateProvider_ParameterValidatorService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_StateProvider_ObjectService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_StateProvider_CreateService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_StateProvider_ContentNegotiationService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_StateProvider_BackedEnumService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_StateProcessor_WriteService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_State_ErrorProviderService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_Serializer_FilterParameterProviderService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_Openapi_SerializerContextBuilderService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_Openapi_ProviderService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_Openapi_OptionsService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_Metadata_PropertySchema_OneOfRestrictionService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_Metadata_PropertySchema_CollectionRestrictionService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_Listener_ExceptionService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_Jsonld_Action_ContextService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_JsonSchema_BackwardCompatibleSchemaFactoryService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_Doctrine_Orm_State_RemoveProcessorService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_Doctrine_Orm_State_PersistProcessorService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_Doctrine_Orm_State_ItemProviderService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_Doctrine_Orm_State_CollectionProviderService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_Doctrine_Orm_QueryExtension_PaginationService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_Doctrine_Orm_QueryExtension_FilterEagerLoadingService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_Doctrine_Orm_QueryExtension_FilterService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_Doctrine_Orm_QueryExtension_EagerLoadingService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_Doctrine_Orm_LinksHandlerService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_Doctrine_Orm_Extension_ParameterExtensionService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_Action_NotFoundService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_Action_NotExposedService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_Action_EntrypointService.php';
require __DIR__.'/ContainerHG4X8As/getApiPlatform_Action_DocumentationService.php';
require __DIR__.'/ContainerHG4X8As/getTemplateControllerService.php';
require __DIR__.'/ContainerHG4X8As/getRedirectControllerService.php';
require __DIR__.'/ContainerHG4X8As/getRegistrarUsuarioService.php';
require __DIR__.'/ContainerHG4X8As/getUsuarioRepositoryService.php';
require __DIR__.'/ContainerHG4X8As/getGiftcardProdutoRepositoryService.php';
require __DIR__.'/ContainerHG4X8As/getAuthUsuarioRepositoryService.php';
require __DIR__.'/ContainerHG4X8As/getVendaControllerService.php';
require __DIR__.'/ContainerHG4X8As/getUsuarioControllerService.php';
require __DIR__.'/ContainerHG4X8As/getPagamentoControllerService.php';
require __DIR__.'/ContainerHG4X8As/getGiftcardValueControllerService.php';
require __DIR__.'/ContainerHG4X8As/getGiftcardSerialControllerService.php';
require __DIR__.'/ContainerHG4X8As/getGiftcardProdutoControllerService.php';
require __DIR__.'/ContainerHG4X8As/getDadosBancoControllerService.php';
require __DIR__.'/ContainerHG4X8As/getAuthControllerService.php';
require __DIR__.'/ContainerHG4X8As/get_ServiceLocator_ZHyJIs5_KernelregisterContainerConfigurationService.php';
require __DIR__.'/ContainerHG4X8As/get_ServiceLocator_ZHyJIs5_KernelloadRoutesService.php';
require __DIR__.'/ContainerHG4X8As/get_ServiceLocator_ZHyJIs5Service.php';
require __DIR__.'/ContainerHG4X8As/getVendaControllercomprarService.php';
require __DIR__.'/ContainerHG4X8As/getUsuarioControllerviewUserService.php';
require __DIR__.'/ContainerHG4X8As/get_ServiceLocator_IqTbbfRService.php';
require __DIR__.'/ContainerHG4X8As/getVendaControllerdeletarService.php';
require __DIR__.'/ContainerHG4X8As/getGiftcardProdutoControllerlistarTodosService.php';
require __DIR__.'/ContainerHG4X8As/getGiftcardProdutoControllerbuscarPorIdService.php';
require __DIR__.'/ContainerHG4X8As/get_ServiceLocator_AfvusP0Service.php';
require __DIR__.'/ContainerHG4X8As/get_ServiceLocator_AVKDDNUService.php';
require __DIR__.'/ContainerHG4X8As/get_ServiceLocator_ZyP9f7KService.php';
require __DIR__.'/ContainerHG4X8As/getVendaControllerlistarPorUsuarioService.php';
require __DIR__.'/ContainerHG4X8As/getGiftcardProdutoControllercriarService.php';
require __DIR__.'/ContainerHG4X8As/getGiftcardValueControllercriarService.php';
require __DIR__.'/ContainerHG4X8As/getGiftcardValueControllerlistarPorProdutoIdService.php';
require __DIR__.'/ContainerHG4X8As/get_Security_RequestMatcher_GOpgIHxService.php';
require __DIR__.'/ContainerHG4X8As/get_Security_RequestMatcher_EXaJb_CService.php';
require __DIR__.'/ContainerHG4X8As/get_Security_RequestMatcher_NaFk5J1Service.php';
require __DIR__.'/ContainerHG4X8As/get_Debug_ValueResolver_Security_UserValueResolverService.php';
require __DIR__.'/ContainerHG4X8As/get_Debug_ValueResolver_Security_SecurityTokenValueResolverService.php';
require __DIR__.'/ContainerHG4X8As/get_Debug_ValueResolver_Doctrine_Orm_EntityValueResolverService.php';
require __DIR__.'/ContainerHG4X8As/get_Debug_ValueResolver_ArgumentResolver_VariadicService.php';
require __DIR__.'/ContainerHG4X8As/get_Debug_ValueResolver_ArgumentResolver_UidService.php';
require __DIR__.'/ContainerHG4X8As/get_Debug_ValueResolver_ArgumentResolver_SessionService.php';
require __DIR__.'/ContainerHG4X8As/get_Debug_ValueResolver_ArgumentResolver_ServiceService.php';
require __DIR__.'/ContainerHG4X8As/get_Debug_ValueResolver_ArgumentResolver_RequestPayloadService.php';
require __DIR__.'/ContainerHG4X8As/get_Debug_ValueResolver_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/ContainerHG4X8As/get_Debug_ValueResolver_ArgumentResolver_RequestService.php';
require __DIR__.'/ContainerHG4X8As/get_Debug_ValueResolver_ArgumentResolver_QueryParameterValueResolverService.php';
require __DIR__.'/ContainerHG4X8As/get_Debug_ValueResolver_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/ContainerHG4X8As/get_Debug_ValueResolver_ArgumentResolver_DefaultService.php';
require __DIR__.'/ContainerHG4X8As/get_Debug_ValueResolver_ArgumentResolver_DatetimeService.php';
require __DIR__.'/ContainerHG4X8As/get_Debug_ValueResolver_ArgumentResolver_BackedEnumResolverService.php';
require __DIR__.'/ContainerHG4X8As/get_Debug_ValueResolver_ApiPlatform_ArgumentResolver_PayloadService.php';
require __DIR__.'/ContainerHG4X8As/get_Debug_Security_Voter_Security_Access_RoleHierarchyVoterService.php';
require __DIR__.'/ContainerHG4X8As/get_Debug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/ContainerHG4X8As/get_Debug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
...
$classes[] = 'Core\UseCase\Usuario\AutenticarUsuario';
$classes[] = 'App\Infra\JwtTokenService';
$classes[] = 'App\Controller\DadosBancoController';
$classes[] = 'App\Controller\GiftcardProdutoController';
$classes[] = 'App\Controller\GiftcardSerialController';
$classes[] = 'App\Controller\GiftcardValueController';
$classes[] = 'App\Controller\PagamentoController';
$classes[] = 'App\Controller\UsuarioController';
$classes[] = 'Core\UseCase\Usuario\AtualizarUsuario';
$classes[] = 'Core\UseCase\Usuario\RemoverUsuario';
$classes[] = 'App\Controller\VendaController';
$classes[] = 'App\Repository\AuthUsuarioRepository';
$classes[] = 'App\Repository\GiftcardProdutoRepository';
$classes[] = 'App\Repository\UsuarioRepository';
$classes[] = 'Core\UseCase\Usuario\RegistrarUsuario';
